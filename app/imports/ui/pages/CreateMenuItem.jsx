...
import { StudentFormSchema as formSchema2 } from '../forms/StudentFormInfo';
...
class CreateMenuItem extends React.Component {
  ...
  submit(data, formRef) {
    let insertError;
    const { name, email, instructor, bio, level, gpa, enrolled, hobbies, major } = data;
    StudentData.insert({ name, email, instructor, bio, level, gpa: gpa2Number(gpa), hobbies, major },
